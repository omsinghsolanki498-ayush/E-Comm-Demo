              ...
              >
                ...
                <div className="relative overflow-hidden bg-gray-100">
                  ...
                  <img
                    ...
                    className="w-full h-64 sm:h-60 lg:h-64 object-cover group-hover:scale-105 transition-transform duration-500"
                    onError={(e) => {
                      e.currentTarget.src =
                        "https://via.placeholder.com/300x300?text=No+Image";
                    }}
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-5">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 border border-gray-300 text-gray-800 py-2.5 rounded-lg font-semibold hover:bg-gray-100 transition"
                    >
                      <Edit size={17} />
                      Edit
                    </button>
                    ...
                    <button
                      type="button"
                      onClick={() => deleteProduct(item._id)}
                      className="flex items-center justify-center gap-2 bg-red-600 text-white py-2.5 rounded-lg font-semibold hover:bg-red-700 transition"
                    >
                      <Trash2 size={17} />
                      Delete
                    </button>
